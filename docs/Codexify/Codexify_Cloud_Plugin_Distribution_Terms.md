...
However, for a plugin to receive official Codexify endorsement and be distributed through
Codexify Cloud, the following terms apply:

## ✅ Official Endorsement Requirements

- The plugin must pass a technical and symbolic review by the Codexify Core Team.
...
- The plugin must adhere to the Codexify Plugin SDK and integration guidelines.

## 🗝️ Approval and Removal

The Codexify Core Team reserves the right to accept, reject, or remove any plugin
...
Codexify inference infrastructure. Developers may choose to license their plugin logic
