...
class SystemIntegrationTest(unittest.TestCase):
    ...
    def test_thread_management(self):
        ...
        self.thread_manager.register_thread("test_worker", worker, "test")
    ...
    def test_codex_awareness(self):
        ...
        # Query memory
        results = self.codex_awareness.query_memory(query="test", tags=["test"])
    ...
    def test_full_system_interaction(self):
        ...
        self.test_threads.append(worker)
        self.thread_manager.register_thread("integration_test", worker, "test")
        ...
        reflection = self.metacognition.reflect_on_decision(
            ...
            context={"thread_health": thread_health, "memory_id": memory_id},
        ...
        results = self.codex_awareness.query_memory(
            query="integration_test", tags=["outcome"]
        )
